...
object Schema {
  ...
  class ConferenceTable(tag: Tag) extends IdTable[Conference, Long](tag, "CONFERENCE") {
  ...
  val Conferences = new IdTableQuery[Conference, Long, ConferenceTable](tag => new ConferenceTable(tag)) {
